...
const MovieList = ({ type = null, genre = null, searchQuery = null, timeFrame = null }) => {
  ...
  const { data, isError, isLoading, isPreviousData } = useQuery([type, genre, params.page, searchQuery, timeFrame], () => {
    ...
    // If trending + timeFrame
    if (timeFrame) return getTrending(timeFrame, params.page);
